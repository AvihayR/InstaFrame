const SimilarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg aria-label="Similar accounts" fill="currentColor" height="16" role="img" viewBox="0 0 24 24" width="16" {...props}>
