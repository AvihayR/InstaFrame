const MultiImgIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg aria-label="Carousel" fill="currentColor" height="24" role="img" viewBox="0 0 48 48" width="24" {...props}>
        <title>Multi image post</title>
